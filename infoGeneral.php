            ...
            <div class="row">
                <div id="menu" class="col-3">
                    <ul class="letra">
                        ...
                        <li id="selec" class="ult"><!--PUNTO DE REFERENCIA-->
                            <span>Información general</span>
                        </li>
                    </ul>
                </div>
                <div id="section" class="col-9">
                    <h5>¿Que ofrece la web?</h5> <p>E.T32 Respuestas está optimizada para la resolución de incertidumbres de los estudiantes con respecto a sus especialidad; donde los directivos, profesores y/o estudiantes que poseen el conocimiento para responder la interrogante, a fin de que la duda sea resuelta.</p>
