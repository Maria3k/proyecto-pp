  ...
  <div class="action" >
    ...
    <div class="menu">
      <ul>
        ...
        ';
  if ($_POST) {
    $query = $con->query("INSERT INTO `pregunta`(`usuario`, `contenido`, `fechaPreguntada`, `respondida`, `especialidad`) VALUES (".$_SESSION["id_usuario"].",'".$_POST["pregunta"]."','".date('Y-m-d')."',0,2)") or die("Error en el insert --->".$query.mysqli_error($con));
  }
} else {
