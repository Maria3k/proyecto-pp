...
<html lang="es">
  ...
  <body>
    <nav>
      <a href="index.html" title="Pagina Principal"><img class="img1" src="assets/img/escuela/loguito.png" alt="minilogo.png"></a>
      <a class="btn-nav" href="register.html">Register</a><a class="btn-nav" href="login.html">Iniciar Sesion</a>
    </nav>
    <div class="container">
      <div class="row">
        <div class="col"></div>
