...
<head>
    ...
    <link rel="stylesheet" href="assets/css/registercopy.css">
                        ...
                        <form id="login" class="myForm text-center" method="post">
                            <div class="main">
                                <div>
                                    ...
                                    <input class="input-field" id="emailogin" type="email" name="email" pattern="[a-zA-Z0-9!#$%&'*_+-]([\.]?[a-zA-Z0-9!#$%&'*_+-])+@[a-zA-Z0-9]([^@&%$\/()=?¿!.,:;]|\d)+[a-zA-Z0-9][\.][a-zA-Z]{2,4}([\.][a-zA-Z]{2})?" required>
                                </div>
                                <div>
                                    <label for="Contraseña">Contraseña</label>
                                    <i class="fas fa-lock icono"></i>
                                    <input class="input-field" id="contralogin" type="password" name="contraseña" pattern="[A-Za-z-0-9]{2,16}" required>
                                    <div id="error"></div>
                                </div>
                        ...
                        <form id="register" class="input-group" method="post">
                            <div class="container">
                                ...
                                <div class="row">
                                    <div class="row">
                                        <div class="main">
                                            <div class="i text-center labelR">
                                                <div class="input-group text-center">
                                                    <label for="Nombre">Nombre</label>
                                                    <input class="input-fiel text-center col-5 mx-auto" id="nombre" type="text" name="nombre" pattern="[A-Za-z-0-9]{3,16}" required>
                                                </div>
                                                <div class="input-group text-center">
                                                    <label for="Apellido">Apellido</label>
                                                    <input class="input-fiel text-center col-5 mx-auto" id="apellido" type="text" name="apellido" pattern="[A-Za-z-0-9]{3,16}" required>
                                                </div>
                                            </div>
                                            <div class="labelR">
                                                <label for="Nombre de usuario">Nombre de usuario</label>
                                                <input class="input-fiel" id="nickname" type="text" name="nickname" pattern="[A-Za-z-0-9]{3,16}" required>
                                                <div id="errorUsuario"></div>
                                            </div>
                                            <div class="labelR">
                                                <label for="Email">Email</label>
                                                <input class="input-fiel" id="email" type="email" name="email" pattern="[a-zA-Z0-9!#$%&'*_+-]([\.]?[a-zA-Z0-9!#$%&'*_+-])+@[a-zA-Z0-9]([^@&%$\/()=?¿!.,:;]|\d)+[a-zA-Z0-9][\.][a-zA-Z]{2,4}([\.][a-zA-Z]{2})?" required>
                                                <div id="errorEmail"></div>
                                            </div>
                                            <div class="labelR" >
                                                <label for="Contraseña">Contraseña</label>
                                                <input class="input-fiel" id="contraseña" type="password" name="contraseña" pattern="[A-Za-z-0-9]{8,16}" required>
                                            ...
                                            <div class="labelR">
                                                ...
                                                <input class="input-fiel" id="contraconfi" type="password" name="contraconfi" pattern="[A-Za-z-0-9]{8,16}" required>
